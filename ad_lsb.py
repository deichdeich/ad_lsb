...
if __name__ == "__main__":
    insert_message('A quick brown fox jumps over the lazy dog.', 'lazydog.png', end_string = 'bS&L/TaYq*YD3m`k')
    print('Retrieved message: ', retrieve_message('lazydog_encoded.png', end_string = 'bS&L/TaYq*YD3m`k'))
